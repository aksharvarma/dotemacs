...
(defun ajv/play-music-from-given-folder (foldername)
  ...
  (execute-kbd-macro (read-kbd-macro "mpv SPC --force-window=no SPC --player-operation-mode=cplayer SPC --no-audio-display SPC --loop-playlist SPC --quiet SPC * RET C-x z"))
  )
